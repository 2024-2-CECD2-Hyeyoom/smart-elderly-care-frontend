...
class CarerWeeklyReportScreen extends StatefulWidget {
  const CarerWeeklyReportScreen({super.key});

  @override
  State<CarerWeeklyReportScreen> createState() =>
      _CarerWeeklyReportScreenState();
}

class _CarerWeeklyReportScreenState extends State<CarerWeeklyReportScreen> {
